...
public record IssueDetailDto(int Id, int ProjectId, string Title, string Description, string Status, string Priority, int? ReportedById, string? ReportedByName, string? AssignedToName, string? UpdatedByName, DateTime CreatedAt, DateTime UpdatedAt, List<CommentResponseDto> Comments);
